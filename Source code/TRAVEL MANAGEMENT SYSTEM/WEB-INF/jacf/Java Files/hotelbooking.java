  		...
  		try{
            ...
            if(rs.next())
            {
            	if(!pswd.equals(rs.getString("pswd")))
            	{
					...
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/hotelbooking\";		");
					...
					out.println("<TBODY>");
					out.println("<TR> ");
					out.println("<TD class=header><img src=\"http://localhost:2008/hcutravels/images/frontpage.gif\" width=\"386\" height=\"71\"> <img src=\"http://localhost:2008/hcutravels/images/Hdr_AS_Seal.jpg\" width=\"289\" height=\"71\"><img src=\"images/1animated12-thumb%5B1%5D.gif\" width=\"67\" height=\"50\"></TD>");
					out.println("</TR>");
					out.println("</TBODY>");
					out.println("</TABLE>");
					out.println("</center>");
					...
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\"><div align=\"center\"><strong><span class=\"style12\"><a href=\"http://localhost:2008/hcutravels/cancelhotel.htm\">Cancel Reservation</a></span></strong></div>            <div align=\"center\"></div>");
					out.println("<div align=\"center\"></div></td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/loginhotel.swf\">");
					...
					out.println("</tr>");
					out.println("</table></td>");
					out.println("<td width=\"30%\"><img src=\"http://localhost:2008/hcutravels/images/nizmar_resort1.jpg\" width=\"190\" height=\"147\"></td>");
					out.println("</tr>");
					out.println("</table></td>");
					out.println("</tr>");
					out.println("</table>");
            	...
            	else
            	{
					...
					out.println("if (strErrMsg == \"\" )");
					out.println("{				");
					out.println("document.mainform.action = 	\"http://localhost:2008/examples/servlet/hotelconfirm\";				");
					out.println("document.mainform.submit();");
					out.println("}");
					out.println("else");
					out.println("{alert(strErrMsg);}");
					...
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
					out.println("<div align=\"center\"><strong><a href=\"http://localhost:2008/hcutravels/top15.htm\">SomeTop Guest houses in India </a></strong></div></td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
					out.println("<div align=\"center\"><strong><a href=\"http://localhost:2008/hcutravels/loginhotel.htm\">Book Hotel/Lodging</a></strong></div></td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\"><strong><span class=\"style12\"><a href=\"http://localhost:2008/hcutravels/cancelhotel.htm\">Cancel Reservation </a></span></strong>");
					out.println("<div align=\"center\"></div></td>");
					out.println("</tr>");
					out.println("<tr>");
					out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
					...
					out.println("</tr>");
					out.println("</table>      ");
					out.println("<p><img src=\"http://localhost:2008/hcutravels/images/raj_banner.gif\" width=\"144\" height=\"145\"></p>    <p class=\"style11\">&nbsp;</p></td >");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/bookhotel.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
            ...
            else
            {
				...
				out.println("<tr>");
				out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
                out.println("<div align=\"center\"><strong><span class=\"style12\"><a href=\"http://localhost:2008/hcutravels/cancelhotel.htm\">Cancel Reservation</a> </span></strong></div></td>");
				out.println("</tr>");
				out.println("<tr>");
				out.println("<td bgcolor=\"#FFFFCC\" class=\"style11\">");
				out.println("<div align=\"center\"><strong><a href=\"www.Hotels%20in%20India,%20Indian%20Hotels,%20India%20Hotels%20Directory%20-%20By%20Destinationindia_com.htm\">Hotels in India </a></strong></div></td>");
