  		...
  		try{
            ...
            if(rs.next())
            {
            	if(!pswd.equals(rs.getString("pswd")))
            	{
					...
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/pckglogin\";				");
					...
					out.println("User ???</font><font color=\"#660000\" size=\"3\"> <a href=\"http://localhost:2008/hcutravels/register.htm\">sign ");
            	...
            	else
            	{
					...
					out.println("if (strErrMsg == \"\" )");
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/pckgbooking\";				");
					out.println("document.mainform.submit();");
					out.println("}");
					out.println("else");
					out.println("{alert(strErrMsg);}");
				...
				out.println("<div align=\"center\">");
					...
					out.println("<param name=\"BGCOLOR\" value=\"#FFCCFF\">");
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/button10.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
					out.println("<embed src=\"http://localhost:2008/hcutravels/images/button10.swf\" width=\"105\" height=\"33\" align=\"middle\" quality=\"high\" pluginspage=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" bgcolor=\"#FFCCFF\" ></embed></object>");
