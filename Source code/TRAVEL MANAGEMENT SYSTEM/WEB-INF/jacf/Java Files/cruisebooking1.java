  		...
  		try{
            ...
            if(rs.next())
            {
            	if(!pswd.equals(rs.getString("pswd")))
            	{
					...
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/cruisebooking1\";		");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/loginc.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
					out.println("<embed src=\"http://localhost:2008/hcutravels/images/loginc.swf\" width=\"147\" height=\"34\" quality=\"high\" pluginspage=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" bgcolor=\"#FFCCFF\" ></embed>");
					out.println("</object> ");
					out.println("</div></td>");
					out.println("</tr>");
					out.println("</table></td>");
            	...
            	else
            	{
					...
					out.println("if (strErrMsg == \"\" )");
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/cruiseconfirm\";				");
					out.println("document.mainform.submit();");
					out.println("}");
					out.println("else");
					out.println("{alert(strErrMsg);}");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/bookc.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
