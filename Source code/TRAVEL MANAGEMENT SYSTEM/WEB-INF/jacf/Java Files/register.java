        ...
        PrintWriter out = response.getWriter();
   		...
   		try{
			...
			if(loginid.equals("XXXX"))	
			{
				...
				out.println("{				");
				out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/changeid\";");
				...
				out.println("<TBODY>");
				out.println("<TR> ");
				out.println("<TD height=\"90\" class=header><img src=\"http://localhost:2008/hcutravels/images/frontpage.gif\" alt=\"\" width=\"386\" height=\"71\"><img src=\"http://localhost:2008/hcutravels/images/Hdr_AS_Seal.jpg\" width=\"289\" height=\"71\"> ");
				out.println("<img src=\"http://localhost:2008/hcutravels/images/1animated12-thumb%5B1%5D.gif\" width=\"67\" height=\"50\" align=\"top\"></TD>");
				out.println("</TR>");
				out.println("</TBODY>");
				out.println("</TABLE>");
				out.println("</center>");
				...
				out.println("<td width=\"9%\" bgcolor=\"#000099\"> <div align=\"center\"><a href=\"http://localhost:2008/hcutravels/home.htm\"><font color=\"#FFFFFF\" size=\"5\">Home</font></a></div></td>");
				out.println("<td width=\"13%\" bgcolor=\"#000099\"> <div align=\"center\"><a href=\"http://localhost:2008/hcutravels/services.htm\"><font color=\"#FFFFFF\" size=\"5\">Services</font></a></div></td>");
				...
				out.println("<td width=\"10%\" bgcolor=\"#000099\"> <div align=\"center\"><a href=\"http://localhost:2008/hcutravels/faq.htm\"><font color=\"#FFFFFF\" size=\"5\">FAQs</font></a></div></td>");
				out.println("<td width=\"25%\" bgcolor=\"#0000CC\"> ");
				out.println("<div align=\"center\"><a href=\"http://localhost:2008/hcutravels/register.htm\"><font color=\"#FFFFFF\" size=\"5\">Register ");
				out.println("Yourself</font></a></div></td>");
				out.println("<td width=\"17%\" bgcolor=\"#000099\"> <div align=\"center\"><a href=\"http://localhost:2008/hcutravels/aboutus.htm\"><font color=\"#FFFFFF\" size=\"5\">About ");
				...
				out.println("<p><strong><font color=\"#FF0000\" size=\"5\">The loginid "+request.getParameter("loginid")+"  is already ");
				...
				out.println("</p>");
				out.println("<a href=\"javascript:doSubmit();\"><img src=\"http://localhost:2008/hcutravels/images/createProfile.gif\" width=\"208\" height=\"26\" border=\"0\"></a> ");
				...
				out.println("<p><img src=\"http://localhost:2008/hcutravels/images/twisting_cranberry_wht.jpg\" width=\"300\" height=\"30\"></p>");
				out.println("<p>&nbsp; </p>");
				out.println("</div>");
				out.println("</body>");
				out.println("</html>");
			...
			else
			{
    			...
    			out.println("<tr> ");
      			...
      			out.println("<td width=\"49%\"><font color=\"#330066\" size=\"3\">"+loginid+"</font></td>");
    			out.println("</tr>");
    			out.println("<tr> ");
