  		...
  		try{
            ...
            if(rs.next())
            {
            	if(!pswd.equals(rs.getString("pswd")))
            	{
					...
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/flightlogin\";				");
					...
					out.println("<td width=\"32%\" bgcolor=\"#0000CC\"> <div align=\"center\"><a href=\"http://localhost:2008/hcutravels/travelinsurance\"><font color=\"#FFFFFF\" size=\"4\">Travel ");
					...
					out.println("<td width=\"588\"><table width=\"100%\" height=\"260\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" background=\"http://localhost:2008/hcutravels/images/airfare_search_bg_big.gif\">");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/button8.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
					out.println("<param name=\"bgcolor\" value=\"#FFCCFF\">");
					out.println("<embed src=\"http://localhost:2008/hcutravels/images/button8.swf\" quality=\"high\" pluginspage=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"147\" height=\"34\" bgcolor=\"#FFCCFF\"></embed> ");
					out.println("</object>");
					out.println("</div></td>");
					out.println("</tr>");
					out.println("</table>");
					out.println("</div></td>");
					out.println("<td width=\"30%\"><img src=\"http://localhost:2008/hcutravels/images/flight.jpg\" width=\"177\" height=\"218\"></td>");
					out.println("</tr>");
					out.println("</table></td>");
					out.println("</tr>");
					out.println("</table>");
            	...
            	else
            	{
					...
					out.println("if (strErrMsg == \"\" )");
					out.println("{				");
					out.println("document.mainform.action = \"http://localhost:2008/examples/servlet/flightbooking\";				");
					out.println("document.mainform.submit();");
					out.println("}");
					out.println("else");
					out.println("{alert(strErrMsg);}");
					...
					out.println("</table>");
					out.println("<p align=\"center\"><img src=\"http://localhost:2008/hcutravels/images/108937881992.jpg\" width=\"125\" height=\"125\"></p></td>");
					out.println("<td width=\"586\"><table width=\"100%\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" background=\"http://localhost:2008/hcutravels/images/airfare_search_bg_big.gif\">");
					out.println("<tr bgcolor=\"#FFCCFF\"> ");
					...
					out.println("<param name=\"movie\" value=\"http://localhost:2008/hcutravels/images/button7.swf\">");
					out.println("<param name=\"quality\" value=\"high\">");
					out.println("<embed src=\"http://localhost:2008/hcutravels/images/button7.swf\" base=\"\"  quality=\"high\" pluginspage=\"http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash\" type=\"application/x-shockwave-flash\" width=\"103\" height=\"30\" ></embed></object>");
					out.println("</p></td>");
					out.println("</tr>");
					out.println("</table>");
					out.println("<p align=\"center\">&nbsp;</p>");
